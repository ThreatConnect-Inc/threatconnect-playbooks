...
class TestArgcheck:
    ...
    def test_bool(self):
        ...
        assert argcheck(self, 't', types=bool) is True
        assert argcheck(self, 'f', types=bool) is False
        assert argcheck(self, 'tb', types=bool) is True
        assert argcheck(self, 'fb', types=bool) is False
